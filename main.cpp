...
int main()
{
  ...
  */
  ...
  Triangle t1;
  t1.Set_AngleA_Lengtha_Anglex(30, 8, 60);
  t1.Get_Summary();
  /*
  Angle Length Length
  ...
  Triangle t1;
  t1.Set_AngleA_Lengtha_Lengthx(50, 7, 9, false);
  t1.Get_Summary();
  t1.Set_AngleA_Lengtha_Lengthx(50, 7, 9, true);
  t1.Get_Summary();

  t1.Set_AngleA_Lengtha_Lengthx(60, 5, 5, false);
  t1.Get_Summary();
  // Fails no obtuse.
  t1.Set_AngleA_Lengtha_Lengthx(60, 5, 5, true);
  t1.Get_Summary();
*/
  /*
By Length Tests
